...
def plot_average_values(data1, data2, title, ylabel, filename):
    ...
    plt.ylim(0, max_value * 1.4)  # Increase y-axis limit by 5%
...
plot_average_values(communication_after_fit_times_shufflenet, communication_after_fit_times_squeezenet, 'Average Communication Phase (After Fit)', 'Time (s)', 'plot_m_c_3d-comm_after_fit_compare.png')
plot_average_values(communication_after_evaluate_times_shufflenet, communication_after_evaluate_times_squeezenet, 'Average Communication Phase (After Evaluate)', 'Time (s)', 'plot_m_c_3d-comm_after_eval_compare.png')
plot_average_values(fit_times_shufflenet, fit_times_squeezenet, 'Average Fit Time', 'Time (s)', 'plot_m_c_3d-fit_compare.png')
plot_average_values(evaluate_times_shufflenet, evaluate_times_squeezenet, 'Average Evaluate Time', 'Time (s)', 'plot_m_c_3d-eval_compare.png')
plot_nethogs(fit_network_usage_nethogs_shufflenet, fit_network_usage_nethogs_squeezenet, 'Average Network Usage (After Fit)', 'Network Usage (byte)', 'plot_m_c_3d-fit_nethogs_compare.png')
plot_nethogs(evaluate_network_usage_nethogs_shufflenet, evaluate_network_usage_nethogs_squeezenet, 'Average Network Usage (After Evaluate)', 'Network Usage (byte)', 'plot_m_c_3d-eval_nethogs_compare.png')